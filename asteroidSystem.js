class AsteroidSystem {
  ...
  constructor(){
    ...
    this.accelerations = [];
    this.diams = [];
    this.startTime = +new Date(); // converts the date into a number with the +
  }
  ...
  spawn(){
    if (random(1)<0.01){
      var gameplayTime = (+new Date() - this.startTime) / 1000;
      var difficulty = 0.1 + gameplayTime / 100;
      console.log(difficulty);
      this.accelerations.push(new createVector(0, difficulty)); // program gets progressively harder as time goes by
